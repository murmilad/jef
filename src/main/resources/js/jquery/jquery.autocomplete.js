...
(function (factory) {
    ...
    Autocomplete.defaults = {
            ...
            onSearchError: noop,
            preserveInput: false,
            containerClass: 'autocomplete-suggestions first_font first_frames_border background_color first_text_color',
            tabDisabled: false,
            dataType: 'text',
            currentRequest: null,
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            // Отключим, поскольку change зарезервирован для связей
        ...
        getSuggestions: function (q) {
            ...
            if (response && Array.isArray(response.suggestions)) {
                ...
                ajaxSettings = {
                    url: serviceUrl,
                    data: options.dataType.toLowerCase()==='json' && options.type.toLowerCase()==='post' ? JSON.stringify(params) : params,
                    type: options.type,
